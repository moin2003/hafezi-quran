...
export const HomeScreen: React.FC<HomeScreenProps> = ({
  ...
  const t = {
    bn: {
      ...
      readBtn: 'কোরআন পড়ুন',
      langToggle: 'English',
      heroTitle: '১৫ লাইনের নূরানী হাফেজী কোরআন শরীফ',
      heroBadge: 'পূর্ণাঙ্গ ৩০ পারা ও ১১৪ সূরা • নূরানী স্ট্যান্ডার্ড',
    ...
    en: {
      ...
      readBtn: 'Read Quran',
      langToggle: 'বাংলা',
      heroTitle: '15-Line Noorani Hafezi Quran Sharif',
      heroBadge: 'COMPLETE 30 PARAS & 114 SURAHS • NOORANI SCRIPT',
