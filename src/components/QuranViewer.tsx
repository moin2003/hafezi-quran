    ...
    >
      ...
      {effectiveMode === 'single' && (
        <div 
          ...
          className="w-full flex-1 flex items-center justify-center relative cursor-pointer select-none px-1 sm:px-4 pt-15 pb-20 sm:pt-18 sm:pb-8 min-h-[100dvh]"
        >
          ...
          >
            <img
              ...
              className="w-auto h-auto max-h-[calc(100dvh-150px)] max-w-full sm:max-h-[86vh] object-contain block mx-auto select-none transition-all drop-shadow-sm"
              loading="eager"
            />
          </div>
        </div>
